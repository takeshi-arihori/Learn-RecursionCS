...
class FarmTest extends TestCase
{
    ...
    {
        // Given: 馬のインスタンス
        $horse = new Horse('Arabian', 1.6, 500.0, 9125.0, 'male', 0.8, 'brown', 38.0, 45.0, 'Thoroughbred', 80.0);
    ...
    {
        // Given: 鶏のインスタンス
        $chicken = new Chicken('Leghorn', 0.6, 2.5, 2190.0, 'female', 0.8, 'white', 'brown', true);
    ...
    {
        // Given: 複数の同じ種類の動物
        $cow1 = new Cow('Holstein', 1.5, 600.0, 7300.0, 'female', 0.5, 'black', 37.0, 4.2, true);
        $cow2 = new Cow('Angus', 1.4, 550.0, 7300.0, 'male', 0.4, 'red', 37.2, 3.8, false);
