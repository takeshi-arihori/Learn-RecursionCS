...
class PlayerTest extends TestCase
{
     ...
     */
    public function testPlayerConstructorInitializesAllPropertiesCorrectly()
    {
     ...
     */
    public function testGetHeightReturnsDefaultHeight()
    {
        // Given: Playerインスタンス
     ...
     */
    public function testAttackSuccessWhenConditionsAreMet()
    {
     ...
     */
    public function testAttackFailsWhenMonsterTooTall()
    {
     ...
     * Then: 攻撃が無効になり、Monsterの体力が変わらない
     */
    public function testAttackFailsWhenAttackTooLow()
    {
     ...
     */
    public function testUnitMismatchCausesAttackToAlwaysFail()
    {
     ...
     */
    public function testAttackReducesMonsterHealthToZeroMinimum()
    {
